...
import { GetFriendChartAPI, GetFriendRequestAPI } from "../request/api";
export default {
  name: "Chart",
  data() {
    return {
  ...
  methods: {
    showchart() {
      ...
      /* this.friendlist = [
        {
          id: 10, //好友id
          imgurl: require("../img/avatar.jpg"), //好友头像
          name: "liu", //好友名称
          time: "14:30", //好友时间
        },
        {
  ...
  mounted() {
    ...
    bus.$off("changeuserAvatar_chart");
    bus.$on("changeuserAvatar_chart", (msg) => {
      this.avatarUrl = msg;
    });
  },
};
